...
-- Tables, User for SQL Injections: 2 tables with prefix MobiStore_
-- --------------------------------------------------------


--
-- Table structure for table `MobiStore_Members`
--

CREATE TABLE IF NOT EXISTS `MobiStore_Members` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `MobiStore_Members`
--

INSERT INTO `MobiStore_Members` (`Id`, `Name`, `Email`, `Password`) VALUES
...
--
-- Table structure for table `MobiStore_Mobiles`
--

CREATE TABLE IF NOT EXISTS `MobiStore_Mobiles` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `MobiStore_Mobiles`
--

INSERT INTO `MobiStore_Mobiles` (`Id`, `Mobile`, `Company`, `Image`) VALUES
