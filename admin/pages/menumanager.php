<?php
/**
 * Hackademic-CMS/admin/pages/menumanager.php
 *
 * The page for managing the menus
 *
...
require_once HACKADEMIC_PATH . "admin/controller/class.MenuManagerController.php";
