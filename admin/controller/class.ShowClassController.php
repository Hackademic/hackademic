...
class ShowClassController extends HackademicBackendController
{
    ...
    private static $_action_type = 'show_class';
    ...
    public function go()
    {
                ...
                if ($_POST['updateclassname']=='') {
                    ...
                    if ($_POST['challenges'] !='default') {
                        ...
                        $this->addSuccessMessage(
                            "Challenge has been added to the class succesfully"
                        );
                    }
        ...
        if (isset($_GET['action']) && $_GET['action'] == "del") {
            if (isset($_GET['uid'])) {
                ...
                $this->addSuccessMessage(
                    "User has been deleted from the class succesfully"
                );
            } else if (isset($_GET['cid'])) {
                ClassChallenges::deleteMembership($_GET['cid'], $class_id);
                $this->addSuccessMessage(
                    "Challenge has been deleted from the class succesfully"
                );
            }
        }
