...
class OptionsController extends HackademicBackendController {
    ...
    private static $_available_themes = array();
  ...
  public function go() {
    ...
    $this->buildView($this->_active_plugins, $this->_active_user_theme);
    $this->generateView();
  }
  ...
  private function handleFormData() {
    ...
    $this->notifyEnabledPlugins(array_diff($this->_active_plugins, Options::getOption('active_plugins')->value));
    $this->notifyDisabledPlugins(array_diff(Options::getOption('active_plugins')->value, $this->_active_plugins));
    ...
    Options::updateOption('active_plugins', $this->_active_plugins);
   ...
   */
  private function get_user_themes() {
