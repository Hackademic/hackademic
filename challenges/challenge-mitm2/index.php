...
<body>
	...
	<section id="mitm_form">
		<form class="form-horizontal" role="form">
			...
			<p>
				Other applications that might reveal usefull:
				<ul>
					<li><a href="rsa.php" target="_blank">RSA Encrypt/Decrypt</a></li>
					<li><a href="base64.php" target="_blank">Base64 Encode/Decode</a></li>
				</ul>
			</p>
		</form>
	</section>
