...
{
	if ($root=="root" && $password=="leetncpassword")
	{
		echo "<p><font color=red>uid=0(root) gid=0(root) groups=0(root)</font>";
		echo "<center><p><h3><font size=5 color=green>Congratulations!</font></h3>";		
	}
	else 
	{
...
{ 
	echo "<hr><p>Enter 'su' to get root privileges <p>You need to be <font color=red>root</font> to execute most of commands.";
}
?>
<br>
<hr>
