<?php
/**
 * PSR2Extended_Sniffs_Commenting_InlineCommentSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://www.frenck.nl/psr2-extended
 */
class PSR2Extended_Sniffs_Commenting_InlineCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        // It will find the last comment in a block, and work its way up.
